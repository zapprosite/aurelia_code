...
- **Monitoramento**: `nvidia-smi` é a fonte primária. Verifique se o `qwen3.5` (Ollama) está consumindo os ~16.5GB necessários de VRAM.
...
- **Modelos Pinados (2026)**:
  - `qwen3.5`: Modelo residente principal (local, agêntico).
  - `qwen3.5-it-q4_K_M`: Laboratório — raciocínio profundo local.
