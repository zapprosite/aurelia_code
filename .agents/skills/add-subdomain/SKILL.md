...
| Tunnel ID | `{{TUNNEL_UUID_HIDDEN}}fc8a-4ddc-a332-bff80012f11f` |
| Tunnel CNAME | `{{TUNNEL_UUID_HIDDEN}}fc8a-4ddc-a332-bff80012f11f.cfargotunnel.com` |
