...
.agents/skills/ (na raiz do repositório)

### Prioridade
Skills de projeto sobrescrevem skills globais de mesmo nome.

## Como acionar uma skill
No seu Agente (Codex/Gemini/Claude), use a sintaxe:
...
## Debugging de skills
- Se o Agente não está seguindo a skill: verifique se o SKILL.md está claro o suficiente.
