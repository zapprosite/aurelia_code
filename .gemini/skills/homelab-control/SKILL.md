...
- **Monitoramento**: `nvidia-smi` é a fonte primária. Verifique se o `27b:12b` (Ollama) está consumindo os ~795MB necessários de VRAM.
...
- **Modelos Pinados (2026)**:
  - `27b:12b`: Modelo residente principal (local, agêntico).
